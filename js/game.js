...
playGame.prototype = {
  ...
  createOverlay: function () {
    ...
    var highScoreText = game.add.bitmapText(game.width - 10, game.height - 10, "font", "Melhor Resultado: " + this.savedData.score.toString(), 30);
    highScoreText.anchor.set(1, 1);
    this.overlayGroup.add(highScoreText);
    this.scoreText = game.add.bitmapText(10, game.height - 10, "font", "Placar: 0", 30);
  ...
  createMenu: function () {
    ...
    var titleText = game.add.bitmapText(game.width / 2, tap.y - 200, "font", "Roller Damsel", 90);
  ...
  addHero: function () {
    this.hero = game.add.sprite(game.width / 2, game.height * gameOptions.floorStart - 100, "hero");
  ...
  checkLadderCollision: function () {
    if (!this.isClimbing) {
      ...
      if (this.hero.y < this.ladderToClimb.y - 100) {
        this.hero.body.gravity.y = gameOptions.playerGravity;
